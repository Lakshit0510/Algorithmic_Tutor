...
export interface LlmSettings { mode: LlmMode; baseUrl?: string; model?: string }
...
export interface TutorState {
  ...
  userPseudocode?: string; feedbackHistory: string[]; feedback?: string; isSolved: boolean; llm: LlmSettings;
}
